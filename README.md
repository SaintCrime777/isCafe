...
--------------------------------------------
✨ Features
功能說明🍽️ 菜單瀏覽分類瀏覽商品，支援手勢滑動（react-swipeable）🛒 購物車即時更新數量與小計，使用 Zustand 管理全域狀態📋 訂單管理建立訂單後可追蹤狀態，資料即時同步至 Supabase🔐 會員系統Email 註冊／登入，使用 Supabase Auth
...
Supabase Auth — 會員註冊／登入／Session 管理
